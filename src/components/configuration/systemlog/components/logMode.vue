...
<template>
  <div class="logMode-container">
    ...
    <el-table :data="tableData" stripe style="width: 100%" v-loading="loading">
      ...
      <el-table-column prop="Explain" label="系统功能" align="center"></el-table-column>
...
.logMode-container  .el-table__body-wrapper{
  min-height: 650px
}
.logMode-container .el-pagination.is-background .el-pager li:not(.disabled).active{
