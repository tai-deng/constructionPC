            ...
            >
              ...
              <div class="from_div_water">
                ...
                <div class="from_div_select">
                  ...
                  <el-select style="width:20%;" v-model="speakPerson" placeholder="人员" @change="handlePerson">
                    <el-option
                  ...
                  <div :class="speakAllList.length==0?'':'from_div_water_add'">
                    <ul>
                      <li v-for="(item ,index) in speakAllList" :key="item.index">
                        <div class="model_list_add_span">
                          <!-- <b>{{index+1}}</b> -->
                          <b>{{index+1}}</b>
                          <span class="dash_right_line">{{OrgTypeName}}</span>
                          <span class="dash_right_line">{{speackText}}</span>
                          <span>{{speakPersonText}}</span>
        ...
        <div v-else-if="fromCurrent==3" class="from">
          ...
          <div class="froms_content">
            ...
            >
              ...
              <el-form-item class="el-form-item-box" label="现场照片">
                <el-upload
                  action
                  list-type="picture-card"
                  :on-change="handlePictureCardSuccess"
...
import { GetDefaultModelId, SaveCommunicate, UploadBase64Img, AddViewPoint, UploadImages, GetOrgList, GetDeptList,
GetUserListByDept, SaveChange, SetGetBuilding, GetSpecialtybyBuilding, GetFloorbyBuilding, PublishRisk, GetRiskTypeList,
