        ...
        <div class="container_left_detail">
          <div class="title">
            ...
            <div class="content">
              ...
              <button :class="['button',{'btn_reserve': brandFold}]" v-if="detailList.length > 3" @click.prevent="changeFoldState()">
                      ...
                      >
                        ...
                        <ul class="position_remove">
                          <li class="scondList" v-for="(item, index) in item.UserRoleList" :key="index">
                            ...
                            <span class="box_span_line"></span>
                            <span class="box_span_border" @click="item.show=!item.show">{{item.cName}}</span>
    ...
    <div class="container_right" >
      <div class="move_container" ref="controll">
        <div  class="container_right_layer " >
          <!-- 左侧按钮 -->
          <button :class="['button', { 'btn_active': modelFold }]" @click.prevent="changeModelFoldState">
          ...
          <div class="project_progress">
            <el-row  class="progress " :gutter="20">
              <el-col :span="2" style="padding: 40px 0 40px 10px ; font-weight:500;color:rgba(51,51,51,1)">项目进度：</el-col>
              <el-col :span="19">
                <el-row> 
...
import { GetOrgList,
 ...
 GetPositionConfig, 
 GetBuilding, 
 GetHomeSchedulePlan} from '@/api/api.js'
...
export default {
  ...
  methods: {
    ...
    changeFoldState() {
      ...
      target.style.height = "730px"
      this.flag = false
      return
      }else {
        target.style.height = "2.11rem"
        this.flag = true
        return
      }
    },
    ...
    async OrgList(){
      ...
      if(userId.StatusCode === 200) {
        ...
        let newArr =  userId.Detiel.filter((item) => {
           return item.OrgTypeID === 1 || item.OrgTypeID === 3 || item.OrgTypeID === 5
        })
    ...
    async EngingConfigByTypeId(){
      ...
      if(engingConfigList.StatusCode === 200) {
        this.detailList = engingConfigList.Detiel
      }else {
        this.$toast({
          message: '后台无数据',
          duration: 800
    ...
    async schedulePlan(data) {
      ...
      let result = await this.Request(GetHomeSchedulePlan({ProjectID: localStorage.getItem('projectid'), BuildingName: data}))
        console.log(result)
        // if(schedule_data.StatusCode === 200) {
