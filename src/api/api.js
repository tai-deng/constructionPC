...
// 单个新增-标准工序
export const add_standard_list=(gms)=>{
  return http.fetchPostGet('SchedulePlan/AddStandardProcedure',gms)
}
// 编辑-标准工序
export const set_standard_list=(pms)=>{
  return http.fetchPostGet('SchedulePlan/EditStandardProcedure',pms)
}
// 删除-标准工序
...
// 关联下拉列表-标准工序
export const pulla_standard_list=(gms)=>{
