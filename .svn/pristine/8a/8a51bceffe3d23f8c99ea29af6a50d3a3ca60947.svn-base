...
<template>
  <div class='shoring-container'>
    ...
    <div class="content-bottom">
      <mainmodel :list="newData" :dataList="dataList" :dataNameList="titleName"></mainmodel>
    </div>
    <!-- 模态框 -->
    <div
  ...
  data() {
    return {
      ...
      dataList: [
        ...
        {id: 1, itemName: '一层地下室',limitTime: '一道水平构件',time:'25天'},
        {id: 2, itemName: '一层地下室',limitTime: '多道水平构件',time:'25天'},
        {id: 3, itemName: '二层地下室',limitTime: '无水平构件',time:'25天'},
        {id: 4, itemName: '二层地下室',limitTime: '双排桩',time:'3天'},
        {id: 5, itemName: '二层地下室',limitTime: '灌注桩+一道锚索',time:'25天'},
        {id: 6, itemName: '二层地下室',limitTime: '灌注桩+二道锚索',time:'3天'},
        {id: 7, itemName: '三层地下室',limitTime: '灌注桩+一道锚索',time:'3天'}
      ],
      titleName: [
         "地下室层数",
         "基坑支护类型",
