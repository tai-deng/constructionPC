    ...
    <div class="cycle_left_main">
      <ul>
        <li :class="currentList==1?'cycle_left_main_li':''" @click="jumpList(1)">
            周期消息 <span :class="currentList==1?'cycle_left_main_span':''"></span>
        </li>
        <li :class="currentList==2?'cycle_left_main_li':''" @click="jumpList(2)">
            三算颜色管理 <span :class="currentList==2?'cycle_left_main_span':''"></span> 
        </li>
          ...
          <div class='cycle_right_main_div'>
              ...
              <div class='cycle_right_form'>
                  <el-row>
                      ...
                      <el-col :span="18">
                            <el-input-number style="width:150px;margin-right:8px" v-model="cycleInput"  :controls='false' :precision='0' :min="1"></el-input-number>天
                      </el-col>
                  </el-row>
      ...
      <div v-if="currentList==2" class="cycle_right_main">
          <div class='cycle_right_body1'>
              <div class="cycle_right_title">
                  <el-row>
                    <el-col :span="10" class="cycle_right_align  cycle_right_align_change">
                        <img class="cycle_right_img" src="../../../assets/imgs/gantt-add-a.png"  @click='addColor()'  alt="">
                        偏差率(%)
                    </el-col>
                    <el-col :span="12" :offset="2" class="cycle_right_align">表示颜色</el-col>
                  </el-row>
              </div>
              <div class="cycle_right_body_color">
                  <ul>
                    <li v-for="(item , index) in colorList"  v-bind:key='index'>
                      <el-row>
                          <el-col :span="12" class="cycle_right_align">
                              <el-select v-model="item.compare"  style="width:60px;">
                                  <el-option v-for='list in numberList' :key='list.value'  
                                        :label="list.label"   :value="list.value" ></el-option>
                              </el-select>
                              <el-input-number :controls='false'  :precision='1'  v-model="item.number" style="width:80px;"></el-input-number>
                          </el-col>
                          <el-col :span="12" class="cycle_right_align">
                              <el-color-picker v-model="item.color" style="width:120px;margin-top:3px;margin-right:30px;"></el-color-picker>
                              <i class="cycle_right_align_del" @click='colorList.splice(index,1)'>-</i>
...
export default {
 data() {
   return {
     ...
     cycleTextarea:'',//内容
     //三算颜色管理
     colorList:[{compare:'=',number:2,color:'#59FF40'}],
     //三算颜色管理--比较大小
     numberList:[{value:'=',label:'='},{value:'<',label:'<'},{value:'>',label:'>'},{value:'≤',label:'≤'},{value:'≥',label:'≥'}],
 ...
 methods:{  
    ...
    saveDay(){
        ...
        if(this.listModuel=='1'){
          //节点对比
          
        }else if(this.listModuel=='2'){
          //三算对比

        }else if(this.listModuel=='3'){
          //施工日志
    ...
    //三算颜色管理
    addColor(){
      let text={compare:'=',number:1,color:null}
